...
`timescale 1 ps / 1 ps
module lab2_qs_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_2_s1_agent:cp_channel
	...
	lab2_qs_mm_interconnect_0_router router (
	...
	lab2_qs_mm_interconnect_0_router_001 router_001 (
	...
	lab2_qs_mm_interconnect_0_router_002 router_002 (
	...
	lab2_qs_mm_interconnect_0_router_003 router_003 (
	...
	lab2_qs_mm_interconnect_0_router_003 router_004 (
	...
	lab2_qs_mm_interconnect_0_router_002 router_005 (
	...
	lab2_qs_mm_interconnect_0_router_002 router_006 (
	...
	lab2_qs_mm_interconnect_0_router_002 router_007 (
	...
	lab2_qs_mm_interconnect_0_router_002 router_008 (
	...
	lab2_qs_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qs_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
